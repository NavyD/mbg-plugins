...
create table pms_product (
  ...
  is_recommended tinyint unsigned not null default 0 comment '推荐状态；0->不推荐；1->推荐',
  is_verified tinyint unsigned not null default 0 comment '审核状态：0->未审核；1->审核通过',
  sort int unsigned not null comment '排序',
  sale int unsigned not null comment '销量',
  price bigint unsigned comment '价格',
  promotion_price bigint unsigned comment '促销价格',
  ...
  original_price bigint unsigned comment '市场价',
